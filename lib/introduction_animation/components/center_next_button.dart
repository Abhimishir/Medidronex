...
import 'package:meddronexx/src/fitness_app_home_screen.dart';
          ...
          SlideTransition(
            ...
            child: AnimatedBuilder(
              ...
              builder: (context, child) => AnimatedOpacity(
                opacity: animationController.value >= 0.2 && animationController.value <= 0.6
                    ? 1
                    : 0,
                    ...
                    child: _signUpMoveAnimation.value > 0.7
                        ? InkWell(
                            ...
                            onTap: () {
                              ...
                              Navigator.push(
                                context,
                                MaterialPageRoute(builder: (context) =>  Meddronex()),
                              );
                            },
                            child: Padding(
